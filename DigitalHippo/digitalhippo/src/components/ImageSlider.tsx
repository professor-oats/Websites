...
const ImageSlider = ({urls}: ImageSliderProps) => {
  ...
  /* To make the slider reactive so that we can slide the pictures
     we have to keep track on the active indicies ourselves and also 
     define the beginning and the end.
     Swiper provides the helping var activeIndex that we can make to set our
     active index with.
  */
