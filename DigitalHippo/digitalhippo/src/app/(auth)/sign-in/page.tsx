          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid gap-2">
              <div className="grid gap-1 py-2">
                ...
                {/* If errors?.email true - display the error from our AuthCredentialsValidator type */}
              ...
              <div className="grid gap-1 py-2">
                ...
                {/* If errors?.password true - display the error from our AuthCredentialsValidator type*/}
